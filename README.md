...
* [Rich CLI Repository](https://github.com/Textualize/rich-cli.git) ⭐ 3,726 | 🐛 46 | 🌐 Python | 📅 2026-08-12 - Rich from the command prompt. Syntax highlight many file-types, with special support for markdown, json, and CSV tables.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,791 | 🐛 3 | 🌐 Python | 📅 2026-08-03 - Interactively find and recover deleted or overwritten files from your terminal.
...
* [Imageview](https://github.com/adamviola/textual-imageview) ⭐ 137 | 🐛 5 | 🌐 Python | 📅 2023-01-08 - A simple terminal-based image viewer.
