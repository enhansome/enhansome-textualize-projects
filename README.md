...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,189 | 🐛 106 | 📅 2026-09-02 [<!--lint ignore no-dead-urls-->![GitHub Actions status | oleksis/awesome-textualize-projects](https://github.com/oleksis/awesome-textualize-projects/actions/workflows/lint.yml/badge.svg)](https://github.com/oleksis/awesome-textualize-projects/actions/workflows/lint.yml) ⭐ 117 | 🐛 7 | 📅 2024-03-18

> A curated list of awesome projects related to [Textualize].

Textualize is responsible for creating frameworks / projects like:

* [Rich](https://github.com/Textualize/rich) ⭐ 57,406 | 🐛 377 | 🌐 Python | 📅 2026-06-23:
  a Python library for rich text and beautiful formatting in the terminal.
* [Textual](https://github.com/Textualize/textual) ⭐ 37,292 | 🐛 359 | 🌐 Python | 📅 2026-07-11:
  a TUI (Text User Interface) framework for Python inspired by modern web development.
* [Rich CLI](https://github.com/Textualize/rich-cli) ⭐ 3,724 | 🐛 47 | 🌐 Python | 📅 2026-08-12:
...
* [Rich CLI Repository](https://github.com/Textualize/rich-cli.git) ⭐ 3,724 | 🐛 47 | 🌐 Python | 📅 2026-08-12 - Rich from the command prompt. Syntax highlight many file-types, with special support for markdown, json, and CSV tables.
...
* [RecoverPy](https://github.com/PabloLec/RecoverPy) ⭐ 1,790 | 🐛 3 | 🌐 Python | 📅 2026-08-03 - Interactively find and recover deleted or overwritten files from your terminal.
* [Pain](https://github.com/1j01/textual-paint) ⭐ 1,122 | 🐛 10 | 🌐 Python | 📅 2026-02-21 - 🎨 MS Paint.<!--lint ignore no-repeat-punctuation-->.<!--lint ignore no-repeat-punctuation-->. in your terminal.
...
* [Rich Pixels](https://github.com/darrenburns/rich-pixels) ⭐ 523 | 🐛 3 | 🌐 Python | 📅 2024-10-18 - A Rich-compatible library for writing pixel images and ASCII art to the terminal.
...
* [Autocomplete](https://github.com/darrenburns/textual-autocomplete) ⭐ 294 | 🐛 17 | 🌐 Python | 📅 2026-01-24 - Easily add autocomplete dropdowns to your Textual apps.
...
* [Terminal](https://github.com/mitosch/textual-terminal) ⭐ 142 | 🐛 11 | 🌐 Python | 📅 2024-06-27 - A terminal emulator widget for Textual.
* [Imageview](https://github.com/adamviola/textual-imageview) ⭐ 138 | 🐛 5 | 🌐 Python | 📅 2023-01-08 - A simple terminal-based image viewer.
...
* [SSHaMan](https://github.com/cornyhorse/sshaman) ⭐ 21 | 🐛 10 | 🌐 Python | 📅 2026-02-27 - SSH Management.
